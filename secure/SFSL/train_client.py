...
for round_num in range(1, communication_rounds + 1):
    ...
    fedsubavg_u2_drop_prop = 0.0  # Do not send masked input dict, and do not participate later procedures
    fedsubavg_u3_drop_prop = 0.0   # Do not send secret shares about others for reconstruction, and do not participate later procedures
    ...
    cpp = 2        # choice of probability parameters, default is 3
    if cpp == 1:
