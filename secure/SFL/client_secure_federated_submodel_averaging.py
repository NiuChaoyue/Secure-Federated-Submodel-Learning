...
def client_side_sfsa_generate_mutual_mask(FEDSUBAVG_SELF_STORAGE, FEDSUBAVG_OTHERS_STORAGE,\
    ...
    modulo_model_r_len = fedsubavg_security_para_dict['modulo_model_r_len']
    modulo_count_r_len = fedsubavg_security_para_dict['modulo_count_r_len']
    #item_count = fedsubavg_security_para_dict['item_count']   # Used for index cate id uniquely and globally [NOT NEEDED]
    ...
    # Special Case for CPP5 and Federated Learning: All chosen clients' downloaded/uploaded submodels are in the same shape
    # Mutual mask with each client in sequence
