...
class Model(object):
    def __init__(self, n_uid, n_mid, n_cat, EMBEDDING_DIM, clip_bound, opt_alg):
    ...
    def build_fcn_net(self, inp, use_dice=True):
        ...
        with tf.name_scope('Metrics'):
            ...
            if self.opt_alg == 'adam':
                ...
                clip_gradients, _ = tf.clip_by_global_norm(gradients, self.clip_bound)
...
class Model_DIN(Model):
    def __init__(self, n_uid, n_mid, n_cat, EMBEDDING_DIM, clip_bound, opt_alg='sgd'):
        super(Model_DIN, self).__init__(n_uid, n_mid, n_cat, EMBEDDING_DIM, clip_bound, opt_alg)
