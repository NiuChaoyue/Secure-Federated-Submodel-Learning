...
print('5. generate_voc is running')
f_train = open("./taobao_local_train", "r")
uid_dict = {}
mid_dict = {}
cat_dict = {}
...
cPickle.dump(uid_voc, open("taobao_uid_voc.pkl", "w"))
cPickle.dump(mid_voc, open("taobao_mid_voc.pkl", "w"))
cPickle.dump(cat_voc, open("taobao_cat_voc.pkl", "w"))
print "finished"
