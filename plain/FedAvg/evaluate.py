...
def eval_and_save(variables_pack_for_eval_and_save, round_num, sess):
    ...
    if variables_pack_for_eval_and_save['best_auc'] < test_auc:
        ...
        variables_pack_for_eval_and_save['saver'].save(sess, variables_pack_for_eval_and_save['CHECKPOINT_DIR_BEST'])
    if round_num % 10 == 0:
        variables_pack_for_eval_and_save['saver'].save(sess, variables_pack_for_eval_and_save['CHECKPOINT_DIR_CURRENT'])
