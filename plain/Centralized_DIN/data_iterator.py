...
class DataIterator:
    ...
    def __init__(self, source,
        ...
        f_meta = open("../taobao_data_process/central_taobao_data/taobao-item-info", "r")
    ...
    def next(self):
        ...
        if len(self.source_buffer) == 0:
            ...
            if self.sort_by_length:
                ...
                tidx = his_length.argsort() #indexes of ascending elements
        ...
        try:
            ...
            while True:
                ...
                uid = self.source_dicts[0][ss[1]] if ss[1] in self.source_dicts[0] else 0 #uid
                mid = self.source_dicts[1][ss[2]] if ss[2] in self.source_dicts[1] else 0 #iid
                cat = self.source_dicts[2][ss[3]] if ss[3] in self.source_dicts[2] else 0 #cid
                tmp = []
                ...
                for fea in ss[5].split(""):
                    ...
                    tmp1.append(c)
                cat_list = tmp1 # history cate list
